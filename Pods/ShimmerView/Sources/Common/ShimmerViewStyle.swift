...
public extension ShimmerViewStyle {
    static let `default` = ShimmerViewStyle(baseColor: UIColor(named: "Colors/loadingItem")!, highlightColor: UIColor(red: 247/255, green: 247/255, blue: 247/255, alpha: 0.8), duration: 1.2, interval: 0.4, effectSpan: .points(120), effectAngle: 0 * CGFloat.pi)
}
